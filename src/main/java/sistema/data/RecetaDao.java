...
public class RecetaDao {
    ...
    public void create(Receta r) throws Exception{
        ...
        stm.setDate(4, r.getFechaConfeccion() != null ? Date.valueOf(r.getFechaConfeccion()) : null);
        stm.setDate(5, r.getFechaRetiro() != null ? Date.valueOf(r.getFechaRetiro()) : null);
        stm.setString(6, r.getEstado());
        ...
        for (MedicamentoDetalle detalle : r.getMedicamentos()) {
            ...
            stmDetalle.setString(1, r.getId());
    ...
    private List<MedicamentoDetalle> getMedicamentosDeReceta(String recetaId) throws Exception {
